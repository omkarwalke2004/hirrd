...
const Schema=z.object({
  experience:z.number().min(0,{message:"Experince must be at least 0"}).int(),
  skills:z.string().min(1,{message:"Skills are required"}),
  education:z.enum(["Intermediate","Graduate","Post Graduate"],{
    message:"Educatpon level is required"
  }),
  resume:z.any().refine(file=>file[0] && (
    file[0].type === "application/pdf"||
    file[0].type === "application/msword"
  ),{
    message:"Resume should be a PDF or Word document"
  }),
...
const onSubmit=(data)=>{
  ...
  <DrawerContent>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 p-4 pb-0">
        <Input  type="number" placeholder="years of Experince" className="flex-1"
        {...register("experience",{
          valueAsNumber:true,
        })}
        />
